 ...
 */
package io.github.me0wzz.music.service
...
import io.github.me0wzz.appthemehelper.util.VersionUtils.hasMarshmallow
import io.github.me0wzz.appthemehelper.util.VersionUtils.hasQ
import io.github.me0wzz.music.*
import io.github.me0wzz.music.activities.LockScreenActivity
...
import io.github.me0wzz.music.model.Song.Companion.emptySong
import io.github.me0wzz.music.model.smartplaylist.AbsSmartPlaylist
import io.github.me0wzz.music.providers.HistoryStore
import io.github.me0wzz.music.providers.MusicPlaybackQueueStore
import io.github.me0wzz.music.providers.SongPlayCountStore
import io.github.me0wzz.music.service.AudioFader.Companion.startFadeAnimator
import io.github.me0wzz.music.service.notification.PlayingNotification
import io.github.me0wzz.music.service.notification.PlayingNotificationClassic.Companion.from
import io.github.me0wzz.music.service.notification.PlayingNotificationImpl24.Companion.from
import io.github.me0wzz.music.service.playback.Playback
import io.github.me0wzz.music.service.playback.Playback.PlaybackCallbacks
import io.github.me0wzz.music.util.MusicUtil.getMediaStoreAlbumCoverUri
import io.github.me0wzz.music.util.MusicUtil.getSongFileUri
import io.github.me0wzz.music.util.MusicUtil.isFavorite
import io.github.me0wzz.music.util.MusicUtil.toggleFavorite
import io.github.me0wzz.music.util.PackageValidator
import io.github.me0wzz.music.util.PreferenceUtil.crossFadeDuration
import io.github.me0wzz.music.util.PreferenceUtil.isAlbumArtOnLockScreen
import io.github.me0wzz.music.util.PreferenceUtil.isBluetoothSpeaker
import io.github.me0wzz.music.util.PreferenceUtil.isBlurredAlbumArt
import io.github.me0wzz.music.util.PreferenceUtil.isClassicNotification
import io.github.me0wzz.music.util.PreferenceUtil.isHeadsetPlugged
import io.github.me0wzz.music.util.PreferenceUtil.isLockScreen
import io.github.me0wzz.music.util.PreferenceUtil.isPauseOnZeroVolume
import io.github.me0wzz.music.util.PreferenceUtil.playbackSpeed
import io.github.me0wzz.music.util.PreferenceUtil.registerOnSharedPreferenceChangedListener
import io.github.me0wzz.music.util.PreferenceUtil.unregisterOnSharedPreferenceChangedListener
import io.github.me0wzz.music.util.RetroUtil
import io.github.me0wzz.music.volume.AudioVolumeObserver
import io.github.me0wzz.music.volume.OnAudioVolumeChangedListener
...
class MusicService : MediaBrowserServiceCompat(),
    ...
    override fun onCreate() {
        ...
        restoreState()
        sendBroadcast(Intent("io.github.me0wzz.music.RETRO_MUSIC_SERVICE_CREATED"))
    ...
    override fun onDestroy() {
        ...
        wakeLock?.release()
        sendBroadcast(Intent("io.github.me0wzz.music.RETRO_MUSIC_SERVICE_DESTROYED"))
    }
    ...
    companion object {
        ...
        const val RETRO_MUSIC_PACKAGE_NAME = "io.github.me0wzz.music"
