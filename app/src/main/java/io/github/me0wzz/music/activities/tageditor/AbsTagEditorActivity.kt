 ...
 *
 */
package io.github.me0wzz.music.activities.tageditor
...
import io.github.me0wzz.music.activities.base.AbsBaseActivity
import io.github.me0wzz.music.activities.saf.SAFGuideActivity
...
import io.github.me0wzz.music.repository.Repository
import io.github.me0wzz.music.util.RetroUtil
import io.github.me0wzz.music.util.SAFUtil
...
abstract class AbsTagEditorActivity<VB : ViewBinding> : AbsBaseActivity() {
    ...
    protected fun setImageBitmap(bitmap: Bitmap?, bgColor: Int) {
        if (bitmap == null) {
            editorImage.setImageResource(io.github.me0wzz.music.R.drawable.default_audio_art)
        } else {
